package gusgo.registration.rest.exception;

import com.fasterxml.jackson.databind.exc.InvalidFormatException;
import gusgo.registration.rest.resource.ErrorResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleException(ChangeSetPersister.NotFoundException exception) {
        logger.log(Level.SEVERE, exception.getMessage(), exception);
